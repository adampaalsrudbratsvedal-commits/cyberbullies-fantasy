...
export const syncFantasyPlayers = () => api.post('/fantasy/sync-players-fifa')
...
export const setUserFifaSid = (fifaUsername, sid) => api.post('/admin/set-user-sid', { fifa_username: fifaUsername, fifa_sid: sid })
